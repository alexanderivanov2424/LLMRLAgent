...
class GridMemoryConfig_2(LLMRLAgentConfig):
...
Use your memory of prior episodes to improve your strategy:
[
{{context}}
]
...
- If blocked, find an alternate route around obstacles

What is your next action? Think step-by-step using your memory and grid layout:
