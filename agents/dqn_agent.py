...
class DQNHyperparameters(BaseModel):
    ...
    learning_starts: int = Field(
        default=100000, 
        gt=0, 
        description="Number of steps before starting to learn"
    )
    ...
    train_freq: int = Field(
        default=4, 
        gt=0, 
        description="Frequency of training the model (in steps)"
    )
...
class DQNAgent(BaseAgent):
    ...
    OPTIMIZED_HYPERPARAMS = {
        "MiniGrid-DoorkKey-5x5-v0": DQNHyperparameters
        ( # SOURCE: https://www.researchgate.net/publication/371290959_Hyperparameters_in_Reinforcement_Learning_and_How_To_Tune_Them
            policy="CnnPolicy",
            learning_rate=5e-7,
            buffer_size=1000000,
            learning_starts=100,
        ...
        "MiniGrid-Empty-5x5-v0": DQNHyperparameters
        ( # SOURCE: https://www.researchgate.net/publication/371290959_Hyperparameters_in_Reinforcement_Learning_and_How_To_Tune_Them
            policy="CnnPolicy",
            learning_rate=5e-6,
            buffer_size=500000,
        ...
        "CartPole-v1": DQNHyperparameters
        ...
        "LunarLander-v2": DQNHyperparameters
        ( # SOURCE: https://github.com/DLR-RM/rl-baselines3-zoo/blob/master/hyperparams/dqn.yml
            policy="MlpPolicy",
